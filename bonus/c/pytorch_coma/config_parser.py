...
def read_config(fname):
    ...
    config_parms['visualize_train'] = config.getboolean('Input Output', 'visualize_train')
    ...
    config_parms['visual_train_output_dir'] = config.get('Input Output', 'visual_train_output_dir')
